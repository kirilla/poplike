...
public class MoveStatementDownCommand : IMoveStatementDownCommand
{
    private readonly IDatabaseService _database;

    public MoveStatementDownCommand(IDatabaseService database)
    {
        _database = database;
    }

    public async Task Execute(
        IUserToken userToken, MoveStatementDownCommandModel model)
    {
